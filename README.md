...
Download the "Chemical-disease associations" file (CTD_chemicals_diseases.tsv.gz).

Extract the file.

Rename it to CTD_chemicals_diseases.csv and place it in the data/ directory.
